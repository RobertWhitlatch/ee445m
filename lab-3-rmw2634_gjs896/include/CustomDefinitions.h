...
long AtomicCompareAddNonBlocking(long *semaPt, long value); // writes if >=0
long AtomicAdd(long* semaPt, long value); // never blocks, always writes
